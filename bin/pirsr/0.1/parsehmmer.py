...
def parsehmmsearch(hmmer_out):
    ...
    with open(hmmer_out) as fp:
        ...
        while line:
            ...
            if "==" in line:
                print(
                    "processing  for sequence " + str(query_id) + " and hmm " + hmm_id
                )
                print(line)
            if line.startswith("#") or not line.strip():
                ...
                while line.strip():
                    ...
                    domain_hits[query_id][hmm_id][domain_id]["hmmstart"] = domain_info[
                        6
                    ]
                    ...
                    domain_hits[query_id][hmm_id][domain_id]["envfrom"] = domain_info[
                        12
                    ]
                ...
                print(
                    "process alignments for sequence "
                    + str(query_id)
                    + " and hmm "
                    + hmm_id
                )
                ...
                while process_align:
                    ...
                    if store_alignment:
                        ...
                        domain_hits[query_id][hmm_id][domain_hit_id][
                            "hmmalign"
                        ] = hmmalign
                        domain_hits[query_id][hmm_id][domain_hit_id][
                            "matchalign"
        ...
        for seq_id in matches:
            ...
            for hmm_id in hits:
                ...
                hit_info = "{seq_id}\t{hmm_id}\t{hmmstart}\t{hmmend}\t{hmmalign}\t{start}\t{end}\t{matchalign}\n".format(
                    seq_id, hmm_id, hmmstart, hmmend, hmmalign, start, end, matchalign
                )
                outf.write(hit_info)
