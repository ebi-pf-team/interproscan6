...
class FingerPrint {
    ...
    FingerPrint(String modelName, String modelId, Double evalue) {
        this.modelName = modelName
        this.modelId = modelId
        this.evalue = evalue
    }

    static FingerPrint buildLocationMatch(
            FingerPrint printsMatch,
            int start,
            int end,
            double pvalue,
            double score,
        ...
        FingerPrint newMatch = new FingerPrint(printsMatch.modelName, printsMatch.modelId, printsMatch.evalue)
