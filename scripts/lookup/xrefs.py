...
def main():
    parser = argparse.ArgumentParser(description="complement match lookup with external files infos")
    parser.add_argument('-matches', '--matches', type=str, help="Match lookup parsed")
    parser.add_argument('-entries', '--entries', type=str, help="entries xref file path")
