        ...
        if 'matches' in data and data['matches']:
            for match_key, match_data in data['matches'].items():  # match_key == sig_Acc
                ...
                if match_key == "signal_peptide":
                    ...
                    match["SignalP_release"] = match_data["version"]
                    match["start"] = match_data["locations"][0]["start"]
                    match["end"] = match_data["locations"][0]["end"]
                    match["pvalue"] = match_data["locations"][0]["pvalue"]
