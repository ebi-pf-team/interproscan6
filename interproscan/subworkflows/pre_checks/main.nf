...
workflow PRE_CHECKS {
    ...
    def applications_expected = ['antifam', 'cdd', 'funfam', 'gene3d', 'hamap', 'mobidb', 'ncbifam', 'panther', 'pfam', 'prosite_patterns', 'prosite_profiles', 'sfld', 'signalp', 'smart', 'superfamily']
