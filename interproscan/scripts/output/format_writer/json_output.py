...
def build_json_output_nucleic(seq_matches: dict, output_path: str, version: str):
    ...
    for seq_id, data in seq_matches.items():  # iterates the ORFs
        ...
        if nucleic_seq_id not in results:
            nucleic_seq = data['sequences'][6]
            nucleic_hash = data['sequences'][5]
            cross_references = {
        ...
        # create dict for the open reading frame
        ...
        results[nucleic_seq_id]["openReadingFrames"].append(open_reading_frame)
