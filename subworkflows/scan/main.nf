include { ANTIFAM           } from "${moduleDir}/../antifam"
include { CATH              } from "${moduleDir}/../cath"
include { CDD               } from "${moduleDir}/../cdd"
include { COILS             } from "${moduleDir}/../coils"
include { DEEPTMHMM         } from "${moduleDir}/../deeptmhmm"
include { HAMAP             } from "${moduleDir}/../hamap"
include { INTERPRO_N        } from "${moduleDir}/../interpro-n"
include { MOBIDBLITE        } from "${moduleDir}/../mobidblite"
include { NCBIFAM           } from "${moduleDir}/../ncbifam"
include { PANTHER           } from "${moduleDir}/../panther"
include { PFAM              } from "${moduleDir}/../pfam"
include { PHOBIUS           } from "${moduleDir}/../phobius"
include { PIRSF             } from "${moduleDir}/../pirsf"
include { PIRSR             } from "${moduleDir}/../pirsr"
include { PRINTS            } from "${moduleDir}/../prints"
include { PROSITE_PATTERNS  } from "${moduleDir}/../prosite/patterns"
include { PROSITE_PROFILES  } from "${moduleDir}/../prosite/profiles"
include { SFLD              } from "${moduleDir}/../sfld"
include { SIGNALP           } from "${moduleDir}/../signalp"
include { SMART             } from "${moduleDir}/../smart"
include { SUPERFAMILY       } from "${moduleDir}/../superfamily"
include { TMBED             } from "${moduleDir}/../tmbed"
include { REPORT_NO_MATCHES } from "${moduleDir}/../../modules/no_matches"
